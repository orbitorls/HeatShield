...
def run_nasa_power(station_ids: list[str], start: date, end: date, force: bool) -> None:
    ...
    from scripts.ingest.nasa_power import ingest_station_range
...
def run_era5(station_ids: list[str], start: date, end: date, force: bool) -> None:
    from scripts.ingest.era5 import ingest_range
    ...
    try:
        from app.data.clients.era5_client import _require_libs
        _require_libs()
...
def run_modis(station_ids: list[str], start: date, end: date, force: bool) -> None:
    ...
    from scripts.ingest.modis import ingest_from_client_result
...
def run_tmd(station_ids: list[str], start: date, end: date, force: bool) -> None:
    import asyncio
    from scripts.ingest.build_historical import backfill
